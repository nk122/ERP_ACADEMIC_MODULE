...
<button class="button button1 animate__animated animate__pulse animate__repeat-2" style=" animation: pulse 3s; float:right;
  animation-iteration-count: infinite;" onClick="location.href='teacher.php'"  >Login For Teachers</button>
  <button class="button button1 animate__animated animate__pulse animate__repeat-2" style=" animation: pulse 3s; float:left;
  animation-iteration-count: infinite;" onClick="location.href='admin.php'" style="" >Admin Access</button>
  
<div class="container animate__animated animate__pulse "style=" animation: pulse 3s;
  animation-iteration-count: infinite;" >
<div class="login-box">
<center><h2>Student Module</h2></center>
<div class="row">
