...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:25%; height:100% !important; z-index:9; overflow: hidden; margin-top: -80px;">
  ...
  <a href="teacher_profile.php" class="w3-bar-item w3-button">Edit Profile</a>
  <a href="course_record.php" class="w3-bar-item w3-button" target="iframe_a" >View Database</a>
  ...
  <a href="leave_status.php" class="w3-bar-item w3-button" target="iframe_a" >Check Leave Status</a>
    <a href="resign_t.php" class="w3-bar-item w3-button" target="iframe_a" >Application for Resignation</a>
</div>
